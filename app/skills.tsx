      ...
      >
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-16 items-center z-10">
          <div className="flex flex-col gap-10 p-[5px]">
            ...
            <motion.div
              className="w-96 flex flex-col gap-4 text-lg font-normal lg:flex-row lg:w-full lg:gap-12 lg:border-4 lg:p-8 lg:rounded-2xl lg:border-neutral-700 lg:shadow-lg lg:shadow-black "
              initial={{ opacity: 0.0, x: -40 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{
